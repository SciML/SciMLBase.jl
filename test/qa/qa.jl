...
@testset "Extensions loaded" begin
    for ext in (
            ...
            :SciMLBaseRecipesBaseExt,
            :SciMLBaseReverseDiffExt,
            :SciMLBaseRuntimeGeneratedFunctionsExt,
...
const _ei_own_internals = (
    ...
    :DEFAULT_PLOT_FUNC, :DualEltypeChecker,
    ...
    :is_independent_variable_index, :isdistribution, :isdualtype,
    :reduce_tup, :responsible_map, :sse, :tmap, :totallength, :tspan_indices,
)
