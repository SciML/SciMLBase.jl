...
is when the `jac_prototype` is a `SciMLOperators.AbstractSciMLLinearOperator  `, in which case you
...
function ODEFunction{iip,true}(f;
                 ...
                 if jac === nothing && isa(jac_prototype, SciMLOperators.AbstractSciMLLinearOperator  )
                  if iip
